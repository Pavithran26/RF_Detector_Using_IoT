//A Telegram App bot for ESP8266 that controls the home alarm system.
...
// ----------------------------
// Additional Libraries - each one of these will need to be installed in arduino library manager.
// ----------------------------
#include <RCSwitch.h>  //https:github.com/sui77/rc-switch
#include <UniversalTelegramBot.h> //https://github.com/witnessmenow/Universal-Arduino-Telegram-Bot

// Initialize Wifi connection to the router
char ssid[] = "Pavi's wifi";//Enter your hotspot name     
char password[] = "";//Enter your password || your hotspot is open network default as empty

// Initialize Telegram BOT
#define BOTtoken "//BOT TOKE ADD HERE" //from Botfather
String chat_id = "USER ID ADD HERE"; //telegram user id (to chat with)
...
//  delay(1000); // Sound the buzzer for 1 second (adjust as needed)
